...
public class UserService implements UserDetailsService {
    ...
    // 회원 탈퇴
//    public boolean withdrawal(UserDto userDto, HttpServletResponse response) throws Exception {
//        
//        response.setContentType("text/html;charset=utf-8");
//        
//        PrintWriter out = response.getWriter();
//        
//        if(userRepository.deleteByIdAndPassword(userDto) != 1) {
//            out.println("<script>");
